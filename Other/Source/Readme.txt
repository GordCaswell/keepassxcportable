...
user in an INI file next to KeePassXCPortable.exe called KeePassXCPortable.ini.
...
copy AppNamePortable.ini from this directory to KeePassXCPortable.ini next to
KeePassXCPortable.exe. The options in the INI file are as follows:
